...
import { Activity, CreditCard, DollarSign, Package, Train, Users } from "lucide-react"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Cargo volume and revenue for the past 30 days.</CardDescription>
              </CardHeader>
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Latest cargo shipments across the network.</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentShipments />
              </CardContent>
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed analytics and metrics for your railway operations.</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate and view reports for your railway operations.</CardDescription>
            </CardHeader>
            <CardContent className="h-[400px] flex items-center justify-center">
